...
pub_request_angle.publish(1)

data_angle = rospy.wait_for_message('/yolo_angle', Int32, timeout=30)
#print(data_angle.data)
angle_rad=data_angle.data*pi/180
robot_angle=-(angle_rad)+pi/2





print("----------------------------->publishing angle:", str(data_angle.data))
pub_angle.publish(robot_angle)
